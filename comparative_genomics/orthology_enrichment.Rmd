...
go_odb_aspects_description <- read.delim("../../../bgimazia_musa/Ensete_Musa/go_terms/EV_EG_MABS_enrichment//go_odb_aspects_description.txt") 
...
# save project
```{r save_project}
save.image(file = "orthofinder/EV_AED25_MAB/OrthoFinder.EV.AED25.MAB.RData")
```
